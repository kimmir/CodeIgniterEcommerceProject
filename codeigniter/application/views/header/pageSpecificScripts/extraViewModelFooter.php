...
<script type="text/javascript">
	...
	var channel = pusher.subscribe('modelView-channel');
	...
	channel.bind('view-model-update-event', function(data) {

		var obj = data['mId'];

		var exists = document.getElementById("modelId"+obj);
		if (typeof(exists) != 'undefined' && exists != null) {

			document.getElementById("modelName"+obj).value = data['mName'];
			document.getElementById("modelPrice"+obj).value = data['mPrice'];
			document.getElementById("modelQuantity"+obj).value = data['mQuantity'];
		}
	});

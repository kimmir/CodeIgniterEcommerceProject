...
<script type="text/javascript">
	...
	var channel = pusher.subscribe('categoryView-channel');
	...
	channel.bind('view-category-update-event', function(data) {

		var obj = data['cId'];

		var exists = document.getElementById("categoryId"+obj);
		if (typeof(exists) != 'undefined' && exists != null) {
			document.getElementById("categoryName"+obj).innerText = data['cName'];
		}
	});

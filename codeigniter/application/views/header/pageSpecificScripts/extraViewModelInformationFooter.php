...
<script type="text/javascript">
	...
	var channel = pusher.subscribe('modelViewInformation-channel');
	...
	channel.bind('model-update-event', function(data) {

		var obj = data['mId'];
		if (document.getElementById("modelId").innerText === obj) {
			document.getElementById("quantityUpdate").value = data['mQuantity'];
			document.getElementById("priceUpdate").value = data['mPrice'];
		}
	});
